...
public class Chatidlinkid extends TableImpl<ChatidlinkidRecord> {
     ...
     */
    public final TableField<ChatidlinkidRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>CHATIDLINKID.LINK_ID</code>.
     */
    public final TableField<ChatidlinkidRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT.nullable(false), this, "");
