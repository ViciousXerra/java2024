...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    public LinkRecord(@Nullable Long id, @NotNull String url, @Nullable OffsetDateTime updatedAt, @Nullable OffsetDateTime checkedAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(domain.jooq.tables.pojos.Link value) {
        super(Link.LINK);
